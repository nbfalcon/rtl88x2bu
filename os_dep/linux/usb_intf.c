...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE(0x2357, 0x012E), .driver_info = RTL8822B}, /* TP-LINK */
	{USB_DEVICE(0x2357, 0x0116), .driver_info = RTL8822B}, /* TP-LINK */
	{USB_DEVICE(0x2357, 0x0117), .driver_info = RTL8822B}, /* TP-LINK */
	{USB_DEVICE(0x0846, 0x9055), .driver_info = RTL8822B}, /* Netgear A6150 */
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_REALTEK, 0xB81A, 0xff, 0xff, 0xff), .driver_info = RTL8822B}, /* Default ID */
	{USB_DEVICE(0x04CA, 0x8602), .driver_info = RTL8822B}, /* LiteOn */
	{USB_DEVICE(USB_VENDER_ID_EDOMAX, 0xD822), .driver_info = RTL8822B}, /* Edimax */
	{USB_DEVICE(USB_VENDER_ID_EDOMAX, 0xE822), .driver_info = RTL8822B}, /* Edimax */
	{USB_DEVICE(0x0E66, 0x0025), .driver_info = RTL8822B}, /* Hawking HW12ACU */
	{USB_DEVICE_AND_INTERFACE_INFO(0x2001, 0x331E, 0xff, 0xff, 0xff), .driver_info = RTL8822B}, /* D-Link DWA-181 */
	{USB_DEVICE_AND_INTERFACE_INFO(0x2001, 0x331c, 0xff, 0xff, 0xff), .driver_info = RTL8822B}, /* Dlink DWA-182 rev D1 */
	{USB_DEVICE(0x20F4, 0x808A), .driver_info = RTL8822B}, /* TRENDnet - TEW-808UBM */
	{USB_DEVICE(0x0B05, 0x1841), .driver_info = RTL8822B}, /* ASUS - USB-AC55 B1 */
	{USB_DEVICE(0x0B05, 0x184C), .driver_info = RTL8822B}, /* ASUS - USB-AC53 Nano */
	{USB_DEVICE(0x0B05, 0x19aa), .driver_info = RTL8822B}, /* ASUS - USB-AC58 rev A1*/
	{USB_DEVICE(0x0B05, 0x1870), .driver_info = RTL8822B}, /* ASUS */
	{USB_DEVICE(0x0B05, 0x1874), .driver_info = RTL8822B}, /* ASUS */
	{USB_DEVICE(0x13B1, 0x0043), .driver_info = RTL8822B}, /* Linksys */
	{USB_DEVICE(0x0BDA, 0x2102), .driver_info = RTL8822B}, /* CCNC */
